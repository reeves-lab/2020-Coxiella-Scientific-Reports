...
dir <- getwd()
doc <- read_pptx() 
matching_data = read.csv("DR3 D44 Innate Cells Pearsons Coefficient.csv", header = T, sep = ",", stringsAsFactors = F)
...
print(doc, target = "DR3 D44 T Cells 99000per Matching Clusters all slides.pptx")
