...
# i=1
  ...
  Grouped_cluster_file = paste(dir, "/Grouped_ClusterImages/B D44 Cluster ", Grouped_cluster_number, ".jpeg", sep = "")
  ...
  file.remove(Volcano_Plot_NCvVC, Volcano_Plot_VUvVC, Volcano_Plot_CvNC, Volcano_Plot_CvVU, Grp1_cluster_file, Grp2_cluster_file, Grp1_scatter_file, Grp2_scatter_file, Grouped_cluster_file, Grouped_scatter_file)
  print(i)
}

#GENERATES POWERPOINT 
print(doc, target = "DR3 D44 B Cell 99000per 37p genbyR.pptx")
