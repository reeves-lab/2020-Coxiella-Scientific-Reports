...
Abundance <- read_excel("./Grp 1 D51 Live Cells 20181120 K=20.xlsx", sheet = "Sheet4")
View(Abundance)
Phenotype <- read_excel("./Grp 1 D51 Live Cells 20181120 K=20.xlsx", sheet = "Sheet2")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:335,1:17])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:5360,1:40])
...
###################################
GroupOne_SheetFour <- read_excel("./Grp 1 D51 Live Cells 20181120 K=20.xlsx", sheet = "Sheet4")
...
data <- as.data.frame(data[1:335,1:17])
...
##################################################
### Imports Sheet 4 and Sheet 2 and renames "Abundance" and "Phenotype" respectively, from desired excel file - must change path and excel file name for particular function
Abundance <- read_excel("./Grp 2 D51 Live Cells 20181120 K=15.xlsx", sheet = "Sheet4")
View(Abundance)
Phenotype <- read_excel("./Grp 2 D51 Live Cells 20181120 K=15.xlsx", sheet = "Sheet2")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:333,1:16])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:4995,1:40])
cluster.phenotypes <- cluster.phenotypes[,-3]
results <- importResultsFromTables(cluster.abundances = cluster.abundances, cluster.phenotypes = cluster.phenotypes)
...
#SCATTER PLOT GENERATOR
###################################
GroupTwo_SheetFour <- read_excel("./Grp 2 D51 Live Cells 20181120 K=15.xlsx", sheet = "Sheet4")
...
data <- as.data.frame(data[1:333,1:16])
data$Cluster <- gsub(" ", "_", data$Cluster, fixed = TRUE)
rownames(data) <- data$Cluster
data <- data[,-1]
...
GroupOne_SheetOne <- read_excel("./Grp 1 D51 Live Cells 20181120 K=20.xlsx", sheet = "Sheet1")
write.table(GroupOne_SheetOne, file = "Grp 1 D51 Live Cells 20181120 K=20.txt", sep = "\t",row.names = FALSE, col.names = TRUE)

### Creates a .txt file of sheet one from Group 2 excel file containing all vortex data
GroupTwo_SheetOne <- read_excel("./Grp 2 D51 Live Cells 20181120 K=15.xlsx", sheet = "Sheet1")
write.table(GroupTwo_SheetOne, file = "Grp 2 D51 Live Cells 20181120 K=15.txt", sep = "\t",row.names = FALSE, col.names = TRUE)
...
experiment1 = rescale_to_0_1(experiment_name = "Grp1",
                             experiment_file = "Grp 1 D51 Live Cells 20181120 K=20.txt",
                             rescale = TRUE)
...
experiment2 = rescale_to_0_1(experiment_name = "Grp2",
                             experiment_file = "Grp 2 D51 Live Cells 20181120 K=15.txt",
                             rescale = TRUE)
...
write.csv(experiment1_experiment2_Pearson_correlation, "DR3 D51 Live Cells Comparison Pearsons Coefficient.csv", row.names = FALSE)
...
matching_file_name = "Matching Clusters DR3 D51 Live Cells.txt"
...
write.xlsx(grouped_file, "Phenotype DR3 Day51 Live Cells ALL BACKGROUND.xlsx", row.names=FALSE)
...
Grp1_data = read.table(Grp1_file, sep = "\t", header = TRUE, stringsAsFactors = FALSE)
Grp1_data <- as.data.frame(Grp1_data[1:335,1:17])
Grp1_data$Cluster = paste("Grp1_", Grp1_data$Cluster, sep ="")
...
Grp2_data = read.table(Grp2_file, sep = "\t", header = TRUE, stringsAsFactors = FALSE)
Grp2_data <- as.data.frame(Grp2_data[1:333,1:16])
Grp2_data$Cluster = paste("Grp2_", Grp2_data$Cluster, sep ="")
...
write.xlsx(grouped_data, "Abundance DR3 Day 51 Live Cell Data.xlsx", row.names=TRUE)
...
Phenotype <- read_excel("./Phenotype DR3 Day51 Live Cells ALL BACKGROUND.xlsx", sheet = "Sheet 1")
View(Phenotype)

#Must change parameters of phenotype sheet according to file size
cluster.phenotypes <- as.data.frame(Phenotype[1:10355,1:40])
cluster.phenotypes <- cluster.phenotypes[,-3]
...
a = cluster.phenotypes[which(cluster.phenotypes$Cluster %in% c(1:52)), ]
...
write.xlsx(grouped_file, "Phenotype SPADEVIZR DR3 Day51 Live Cells.xlsx", row.names=FALSE)
...
Abundance <- read_excel("./Abundance DR3 Day 51 Live Cell Data.xlsx", sheet = "Sheet 1")
View(Abundance)
Phenotype <- read_excel("./Phenotype SPADEVIZR DR3 Day51 Live Cells.xlsx", sheet = "Sheet 1")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:51,1:32])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:1581,1:40])
cluster.phenotypes <- cluster.phenotypes[,-3]
...
Control <- c("c05_Grp1_DR3_D51._37p", "c06_Grp1_DR3_D51._37p", "c07_Grp1_DR3_D51._37p", "c08_Grp1_DR3_D51._37p", "c05_GRP2_Day51.37P", "c06_GRP2_Day51.37P", "c07_GRP2_Day51.37P","c08_GRP2_Day51.37P")
Naive_Chal <- c("c01_Grp1_DR3_D51._37p", "c02_Grp1_DR3_D51._37p", "c03_Grp1_DR3_D51._37p", "c04_Grp1_DR3_D51._37p", "c02_GRP2_Day51.37P", "c03_GRP2_Day51.37P", "c04_GRP2_Day51.37P")
Vax_Chal <- c("c09_Grp1_DR3_D51._37p", "c10_Grp1_DR3_D51._37p", "c11_Grp1_DR3_D51._37p", "c12_Grp1_DR3_D51._37p", "c09_GRP2_Day51.37P", "c10_GRP2_Day51.37P", "c11_GRP2_Day51.37P","c12_GRP2_Day51.37P")
Vax_Unchal <- c("c13_Grp1_DR3_D51._37p", "c14_Grp1_DR3_D51._37p", "c15_Grp1_DR3_D51._37p", "c16_Grp1_DR3_D51._37p", "c13_GRP2_Day51.37P", "c14_GRP2_Day51.37P", "c15_GRP2_Day51.37P","c16_GRP2_Day51.37P")
...
write.csv(resultsDAC_CvNC@results, "Control_v_Naive_Chal_DAC_p_values_redo.csv", row.names = FALSE)
...
#SCATTER PLOT GENERATOR
###################################
Grouped_SheetFour <- read_excel("./Abundance DR3 Day 51 Live Cell Data.xlsx", sheet = "Sheet 1")
