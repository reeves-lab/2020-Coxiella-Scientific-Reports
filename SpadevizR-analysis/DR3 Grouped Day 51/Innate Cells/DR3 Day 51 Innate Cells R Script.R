...
Abundance <- read_excel("./Grp 1 DR3 D51 Innate Cells 20180524 K = 35.xlsx", sheet = "Sheet4")
View(Abundance)
Phenotype <- read_excel("./Grp 1 DR3 D51 Innate Cells 20180524 K = 35.xlsx", sheet = "Sheet2")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:65,1:17])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:1040,1:35])
...
###################################
GroupOne_SheetFour <- read_excel("./Grp 1 DR3 D51 Innate Cells 20180524 K = 35.xlsx", sheet = "Sheet4")
...
data <- as.data.frame(data[1:65,1:17])
...
dir.create("Group1_Scatterplots_new", showWarnings = FALSE)
setwd("Group1_Scatterplots_new")
...
##################################################
### Imports Sheet 4 and Sheet 2 and renames "Abundance" and "Phenotype" respectively, from desired excel file - must change path and excel file name for particular function
Abundance <- read_excel("./Grp 2 DR3 D51 Innate Cells 20180524 K = 26.xlsx", sheet = "Sheet4")
View(Abundance)
Phenotype <- read_excel("./Grp 2 DR3 D51 Innate Cells 20180524 K = 26.xlsx", sheet = "Sheet2")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:71,1:16])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:1065,1:35])
cluster.phenotypes <- cluster.phenotypes[,-3]
results <- importResultsFromTables(cluster.abundances = cluster.abundances, cluster.phenotypes = cluster.phenotypes)
...
#SCATTER PLOT GENERATOR
###################################
GroupTwo_SheetFour <- read_excel("./Grp 2 DR3 D51 Innate Cells 20180524 K = 26.xlsx", sheet = "Sheet4")
...
data <- as.data.frame(data[1:71,1:16])
data$Cluster <- gsub(" ", "_", data$Cluster, fixed = TRUE)
rownames(data) <- data$Cluster
data <- data[,-1]
...
dir.create("Group2_Scatterplots_new", showWarnings = FALSE)
setwd("Group2_Scatterplots_new")
x_order = factor(data$group, levels=c("Naive Unchallenged", "Naive Challenged", "Vax Unchallenged","Vax Challenged"), ordered=TRUE)
for(i in 2:ncol(data)){
  scatter_plot <- 
    ggplot(data, aes_string(x = x_order, fill = "group", y = colnames(data)[i]))+ 
...
GroupOne_SheetOne <- read_excel("./Grp 1 DR3 D51 Innate Cells 20180524 K = 35.xlsx", sheet = "Sheet1")
write.table(GroupOne_SheetOne, file = "Grp 1 DR3 D51 Innate Cells 20180524 K = 35.txt", sep = "\t",row.names = FALSE, col.names = TRUE)

### Creates a .txt file of sheet one from Group 2 excel file containing all vortex data
GroupTwo_SheetOne <- read_excel("./Grp 2 DR3 D51 Innate Cells 20180524 K = 26.xlsx", sheet = "Sheet1")
write.table(GroupTwo_SheetOne, file = "Grp 2 DR3 D51 Innate Cells 20180524 K = 26.txt", sep = "\t",row.names = FALSE, col.names = TRUE)
...
experiment1 = rescale_to_0_1(experiment_name = "Grp1",
                             experiment_file = "Grp 1 DR3 D51 Innate Cells 20180524 K = 35.txt",
                             rescale = TRUE)
...
experiment2 = rescale_to_0_1(experiment_name = "Grp2",
                             experiment_file = "Grp 2 DR3 D51 Innate Cells 20180524 K = 26.txt",
                             rescale = TRUE)
#includes count - can # if dont want to rank based on count
...
write.csv(experiment1_experiment2_Pearson_correlation, "DR3 D51 Innate Cells Pearsons Coefficient.csv", row.names = FALSE)
...
matching_file_name = "Matched Clusters DR3 Day 51 Innate Cell 99000per.txt"
...
colnames(grouped_file)[37] = "Cluster_new"
grouped_file = grouped_file[,c(37,1:ncol(grouped_file))]
...
write.xlsx(grouped_file, "Phenotype DR3 Day51 Innate Cells ALL BACKGROUND.xlsx", row.names=FALSE)
...
Grp1_data = read.table(Grp1_file, sep = "\t", header = TRUE, stringsAsFactors = FALSE)
Grp1_data <- as.data.frame(Grp1_data[1:65,1:17])
Grp1_data$Cluster = paste("Grp1_", Grp1_data$Cluster, sep ="")
...
Grp2_data = read.table(Grp2_file, sep = "\t", header = TRUE, stringsAsFactors = FALSE)
Grp2_data <- as.data.frame(Grp2_data[1:71,1:16])
Grp2_data$Cluster = paste("Grp2_", Grp2_data$Cluster, sep ="")
...
write.xlsx(grouped_data, "Abundance DR3 Day 51 Innate Cell Data.xlsx", row.names=TRUE)
...
Phenotype <- read_excel("./Phenotype DR3 Day51 Innate Cells ALL BACKGROUND.xlsx", sheet = "Sheet 1")
View(Phenotype)

#Must change parameters of phenotype sheet according to file size
cluster.phenotypes <- as.data.frame(Phenotype[1:2105,1:35])
cluster.phenotypes <- cluster.phenotypes[,-3]
...
write.xlsx(grouped_file, "Phenotype DR3 Day51 Innate Cells SPADEVIZR.xlsx", row.names=FALSE)
...
Abundance <- read_excel("./Abundance DR3 Day 51 Innate Cell Data.xlsx", sheet = "Sheet 1")
View(Abundance)
Phenotype <- read_excel("./Phenotype DR3 Day51 Innate Cells SPADEVIZR.xlsx", sheet = "Sheet 1")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:15,1:32])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:465,1:35])
cluster.phenotypes <- cluster.phenotypes[,-3]
...
Control <- c("c05_Grp1_DR3_D51_Innate.Cells._37p", "c05_GRP2_DR3_Day51_Innate.Cells._37p", "c06_Grp1_DR3_D51_Innate.Cells._37p", "c06_GRP2_DR3_Day51_Innate.Cells._37p", "c07_Grp1_DR3_D51_Innate.Cells._37p", "c07_GRP2_DR3_Day51_Innate.Cells._37p", "c08_Grp1_DR3_D51_Innate.Cells._37p", "c08_GRP2_DR3_Day51_Innate.Cells._37p")
Naive_Chal <- c("c01_Grp1_DR3_D51_Innate.Cells._37p", "c02_Grp1_DR3_D51_Innate.Cells._37p", "c02_GRP2_DR3_Day51_Innate.Cells._37p", "c03_Grp1_DR3_D51_Innate.Cells._37p", "c03_GRP2_DR3_Day51_Innate.Cells._37p", "c04_Grp1_DR3_D51_Innate.Cells._37p", "c04_GRP2_DR3_Day51_Innate.Cells._37p")
Vax_Chal <- c("c09_Grp1_DR3_D51_Innate.Cells._37p", "c09_GRP2_DR3_Day51_Innate.Cells._37p", "c10_Grp1_DR3_D51_Innate.Cells._37p", "c10_GRP2_DR3_Day51_Innate.Cells._37p", "c11_Grp1_DR3_D51_Innate.Cells._37p", "c11_GRP2_DR3_Day51_Innate.Cells._37p", "c12_Grp1_DR3_D51_Innate.Cells._37p", "c12_GRP2_DR3_Day51_Innate.Cells._37p")
Vax_Unchal <- c("c13_Grp1_DR3_D51_Innate.Cells._37p", "c13_GRP2_DR3_Day51_Innate.Cells._37p", "c14_Grp1_DR3_D51_Innate.Cells._37p", "c14_GRP2_DR3_Day51_Innate.Cells._37p", "c15_Grp1_DR3_D51_Innate.Cells._37p", "c15_GRP2_DR3_Day51_Innate.Cells._37p", "c16_Grp1_DR3_D51_Innate.Cells._37p", "c16_GRP2_DR3_Day51_Innate.Cells._37p")
...
dir.create("SpadevizR Analysis and Volcano Plots all", showWarnings = FALSE)
setwd("SpadevizR Analysis and Volcano Plots")

resultsDAC_CvNC <- identifyDAC(results, condition1 = Control, condition2 = Naive_Chal, th.pvalue = 1.0, th.fc = 1, method.paired = FALSE, use.percentages = FALSE)
...
resultsDAC_CvVU <- identifyDAC(results, condition1 = Control, condition2 = Vax_Unchal, th.pvalue = 1.0, th.fc = 1, method.paired = FALSE, use.percentages = FALSE)
...
resultsDAC_NCvVC <- identifyDAC(results, condition1 = Naive_Chal, condition2 = Vax_Chal, th.pvalue = 1.0, th.fc = 1, method.paired = FALSE, use.percentages = FALSE)
...
resultsDAC_VUvVC <- identifyDAC(results, condition1 = Vax_Unchal, condition2 = Vax_Chal, th.pvalue = 1.0, th.fc = 1, method.paired = FALSE, use.percentages = FALSE)
...
#SCATTER PLOT GENERATOR
###################################
Grouped_SheetFour <- read_excel("./Abundance DR3 Day 51 Innate Cell Data.xlsx", sheet = "Sheet 1")
...
dir.create("Grouped_Scatterplots_new", showWarnings = FALSE)
setwd("Grouped_Scatterplots_new")
x_order = factor(data$group, levels=c("Naive Unchallenged", "Naive Challenged", "Vax Unchallenged","Vax Challenged"), ordered=TRUE)
for(i in 2:ncol(data)){
  scatter_plot <- 
    ggplot(data, aes_string(x = x_order, fill = "group", y = colnames(data)[i]))+ 
