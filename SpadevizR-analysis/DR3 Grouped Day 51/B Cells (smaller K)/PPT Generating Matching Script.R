...
dir <- getwd()
doc <- read_pptx() 
matching_data = read.csv("DR3 D51 B Cells Pearsons Coefficient.csv", header = T, sep = ",", stringsAsFactors = F)
rownumber = 0
...
print(doc, target = "DR3 D51 T Cells 99000per Matching Clusters all slides.pptx")
