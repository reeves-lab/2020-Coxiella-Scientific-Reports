...
matching_file_name = "Matched Clusters DR3 Day 51 T Cell 99000per.txt"
...
write.xlsx(grouped_file, "Phenotype DR3 Day51 T Cells ALL BACKGROUND.xlsx", row.names=FALSE)
...
Grp1_data = read.table(Grp1_file, sep = "\t", header = TRUE, stringsAsFactors = FALSE)
Grp1_data <- as.data.frame(Grp1_data[1:70,1:17])
Grp1_data$Cluster = paste("Grp1_", Grp1_data$Cluster, sep ="")
...
Grp2_data = read.table(Grp2_file, sep = "\t", header = TRUE, stringsAsFactors = FALSE)
Grp2_data <- as.data.frame(Grp2_data[1:73,1:16])
Grp2_data$Cluster = paste("Grp2_", Grp2_data$Cluster, sep ="")
...
write.xlsx(grouped_data, "Abundance DR3 Day 51 T Cell Data.xlsx", row.names=TRUE)
...
Phenotype <- read_excel("./Phenotype DR3 Day51 T Cells ALL BACKGROUND.xlsx", sheet = "Sheet 1")
View(Phenotype)

#Must change parameters of phenotype sheet according to file size
cluster.phenotypes <- as.data.frame(Phenotype[1:2215,1:40])
cluster.phenotypes <- cluster.phenotypes[,-3]
...
dir.create("Grouped_Phenoviewer", showWarnings = FALSE)
setwd("Grouped_Phenoviewer")
...
write.xlsx(grouped_file, "Phenotype DR3 Day51 T Cells SPADEVIZR.xlsx", row.names=FALSE)
...
Abundance <- read_excel("./Abundance DR3 Day 51 T Cell Data.xlsx", sheet = "Sheet 1")
View(Abundance)
Phenotype <- read_excel("./Phenotype DR3 Day51 T Cells SPADEVIZR.xlsx", sheet = "Sheet 1")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:17,1:32])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:527,1:40])
cluster.phenotypes <- cluster.phenotypes[,-3]
...
Control <- c("c05_Grp1_DR3_D51_CD3..T.Cells._37p", "c05_GRP2_DR3_Day51_CD3..T.Cells._37p", "c06_Grp1_DR3_D51_CD3..T.Cells._37p", "c06_GRP2_DR3_Day51_CD3..T.Cells._37p", "c07_Grp1_DR3_D51_CD3..T.Cells._37p", "c07_GRP2_DR3_Day51_CD3..T.Cells._37p", "c08_Grp1_DR3_D51_CD3..T.Cells._37p", "c08_GRP2_DR3_Day51_CD3..T.Cells._37p")
Naive_Chal <- c("c01_Grp1_DR3_D51_CD3..T.Cells._37p", "c02_Grp1_DR3_D51_CD3..T.Cells._37p", "c02_GRP2_DR3_Day51_CD3..T.Cells._37p", "c03_Grp1_DR3_D51_CD3..T.Cells._37p", "c03_GRP2_DR3_Day51_CD3..T.Cells._37p", "c04_Grp1_DR3_D51_CD3..T.Cells._37p", "c04_GRP2_DR3_Day51_CD3..T.Cells._37p")
Vax_Chal <- c("c09_Grp1_DR3_D51_CD3..T.Cells._37p", "c09_GRP2_DR3_Day51_CD3..T.Cells._37p", "c10_Grp1_DR3_D51_CD3..T.Cells._37p", "c10_GRP2_DR3_Day51_CD3..T.Cells._37p", "c11_Grp1_DR3_D51_CD3..T.Cells._37p", "c11_GRP2_DR3_Day51_CD3..T.Cells._37p", "c12_Grp1_DR3_D51_CD3..T.Cells._37p", "c12_GRP2_DR3_Day51_CD3..T.Cells._37p")
Vax_Unchal <- c("c13_Grp1_DR3_D51_CD3..T.Cells._37p", "c13_GRP2_DR3_Day51_CD3..T.Cells._37p", "c14_Grp1_DR3_D51_CD3..T.Cells._37p", "c14_GRP2_DR3_Day51_CD3..T.Cells._37p", "c15_Grp1_DR3_D51_CD3..T.Cells._37p", "c15_GRP2_DR3_Day51_CD3..T.Cells._37p", "c16_Grp1_DR3_D51_CD3..T.Cells._37p", "c16_GRP2_DR3_Day51_CD3..T.Cells._37p")
...
#SCATTER PLOT GENERATOR
###################################
Grouped_SheetFour <- read_excel("./Abundance DR3 Day 51 T Cell Data.xlsx", sheet = "Sheet 1")
