...
Abundance <- read_excel("./Grp 1 D35 Innate Cells 20181211 K=26.xlsx", sheet = "Sheet4")
View(Abundance)
Phenotype <- read_excel("./Grp 1 D35 Innate Cells 20181211 K=26.xlsx", sheet = "Sheet2")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:85,1:17])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:1360,1:35])
...
###################################
GroupOne_SheetFour <- read_excel("./Grp 1 D35 Innate Cells 20181211 K=26.xlsx", sheet = "Sheet4")
...
data <- as.data.frame(data[1:85,1:17])
...
##################################################
### Imports Sheet 4 and Sheet 2 and renames "Abundance" and "Phenotype" respectively, from desired excel file - must change path and excel file name for particular function
Abundance <- read_excel("./Grp 2 D35 Innate Cells 20181211 K=18.xlsx", sheet = "Sheet4")
View(Abundance)
Phenotype <- read_excel("./Grp 2 D35 Innate Cells 20181211 K=18.xlsx", sheet = "Sheet2")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:83,1:17])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:1328,1:35])
cluster.phenotypes <- cluster.phenotypes[,-3]
results <- importResultsFromTables(cluster.abundances = cluster.abundances, cluster.phenotypes = cluster.phenotypes)
...
#SCATTER PLOT GENERATOR
###################################
GroupTwo_SheetFour <- read_excel("./Grp 2 D35 Innate Cells 20181211 K=18.xlsx", sheet = "Sheet4")
...
data <- as.data.frame(data[1:83,1:17])
data$Cluster <- gsub(" ", "_", data$Cluster, fixed = TRUE)
rownames(data) <- data$Cluster
data <- data[,-1]
...
GroupOne_SheetOne <- read_excel("./Grp 1 D35 Innate Cells 20181211 K=26.xlsx", sheet = "Sheet1")
write.table(GroupOne_SheetOne, file = "Grp 1 D35 Innate Cells 20181211 K=26.txt", sep = "\t",row.names = FALSE, col.names = TRUE)

### Creates a .txt file of sheet one from Group 2 excel file containing all vortex data
GroupTwo_SheetOne <- read_excel("./Grp 2 D35 Innate Cells 20181211 K=18.xlsx", sheet = "Sheet1")
write.table(GroupTwo_SheetOne, file = "Grp 2 D35 Innate Cells 20181211 K=18.txt", sep = "\t",row.names = FALSE, col.names = TRUE)
...
experiment1 = rescale_to_0_1(experiment_name = "Grp1",
                             experiment_file = "Grp 1 D35 Innate Cells 20181211 K=26.txt",
                             rescale = TRUE)
...
experiment2 = rescale_to_0_1(experiment_name = "Grp2",
                             experiment_file = "Grp 2 D35 Innate Cells 20181211 K=18.txt",
                             rescale = TRUE)
#includes count - can # if dont want to rank based on count
...
write.csv(experiment1_experiment2_Pearson_correlation, "DR3 D35 Innate Cells Pearsons Coefficient.csv", row.names = FALSE)
...
matching_file_name = "Matching Clusters DR3 D35 Innate Cells.txt"
...
write.xlsx(grouped_file, "Phenotype DR3 Day35 Innate Cells ALL BACKGROUND.xlsx", row.names=FALSE)
...
Grp1_data = read.table(Grp1_file, sep = "\t", header = TRUE, stringsAsFactors = FALSE)
Grp1_data <- as.data.frame(Grp1_data[1:85,1:17])
Grp1_data$Cluster = paste("Grp1_", Grp1_data$Cluster, sep ="")
...
Grp2_data = read.table(Grp2_file, sep = "\t", header = TRUE, stringsAsFactors = FALSE)
Grp2_data <- as.data.frame(Grp2_data[1:83,1:17])
Grp2_data$Cluster = paste("Grp2_", Grp2_data$Cluster, sep ="")
...
write.xlsx(grouped_data, "Abundance DR3 Day 35 Innate Cell Data.xlsx", row.names=TRUE)
...
Phenotype <- read_excel("./Phenotype DR3 Day35 Innate Cells ALL BACKGROUND.xlsx", sheet = "Sheet 1")
View(Phenotype)

#Must change parameters of phenotype sheet according to file size
cluster.phenotypes <- as.data.frame(Phenotype[1:2688,1:35])
cluster.phenotypes <- cluster.phenotypes[,-3]
...
write.xlsx(grouped_file, "Phenotype DR3 Day35 Innate Cells SPADEVIZR.xlsx", row.names=FALSE)
...
Abundance <- read_excel("./Abundance DR3 Day 35 Innate Cell Data.xlsx", sheet = "Sheet 1")
View(Abundance)
Phenotype <- read_excel("./Phenotype DR3 Day35 Innate Cells SPADEVIZR.xlsx", sheet = "Sheet 1")
View(Phenotype)
...
cluster.abundances <- as.data.frame(Abundance[1:19,1:33])
rownames(cluster.abundances) <- cluster.abundances[,1]
cluster.abundances <- cluster.abundances[,-1]

cluster.phenotypes <- as.data.frame(Phenotype[1:608,1:35])
cluster.phenotypes <- cluster.phenotypes[,-3]
...
Control <- c("c05_GRP1_DR3_Day35_Innate.Cells._37p", "c05_Grp2_.DR3_Day35_Innate.Cells._37p", "c06_GRP1_DR3_Day35_Innate.Cells._37p", "c06_Grp2_.DR3_Day35_Innate.Cells._37p", "c07_GRP1_DR3_Day35_Innate.Cells._37p", "c07_Grp2_.DR3_Day35_Innate.Cells._37p", "c08_GRP1_DR3_Day35_Innate.Cells._37p", "c08_Grp2_.DR3_Day35_Innate.Cells._37p", "c01_GRP1_DR3_Day35_Innate.Cells._37p", "c01_Grp2_.DR3_Day35_Innate.Cells._37p", "c02_GRP1_DR3_Day35_Innate.Cells._37p", "c02_Grp2_.DR3_Day35_Innate.Cells._37p", "c03_GRP1_DR3_Day35_Innate.Cells._37p", "c03_Grp2_.DR3_Day35_Innate.Cells._37p", "c04_GRP1_DR3_Day35_Innate.Cells._37p", "c04_Grp2_.DR3_Day35_Innate.Cells._37p")
Vaccinated <- c("c09_GRP1_DR3_Day35_Innate.Cells._37p", "c09_Grp2_.DR3_Day35_Innate.Cells._37p", "c10_GRP1_DR3_Day35_Innate.Cells._37p", "c10_Grp2_.DR3_Day35_Innate.Cells._37p", "c11_GRP1_DR3_Day35_Innate.Cells._37p", "c11_Grp2_.DR3_Day35_Innate.Cells._37p", "c12_GRP1_DR3_Day35_Innate.Cells._37p", "c12_Grp2_.DR3_Day35_Innate.Cells._37p", "c13_GRP1_DR3_Day35_Innate.Cells._37p", "c13_Grp2_.DR3_Day35_Innate.Cells._37p", "c14_GRP1_DR3_Day35_Innate.Cells._37p", "c14_Grp2_.DR3_Day35_Innate.Cells._37p", "c15_GRP1_DR3_Day35_Innate.Cells._37p", "c15_Grp2_.DR3_Day35_Innate.Cells._37p", "c16_GRP1_DR3_Day35_Innate.Cells._37p", "c16_Grp2_.DR3_Day35_Innate.Cells._37p")
...
#SCATTER PLOT GENERATOR
###################################
Grouped_SheetFour <- read_excel("./Abundance DR3 Day 35 Innate Cell Data.xlsx", sheet = "Sheet 1")
