...
data <- read.csv("DR3 D10 T Cells Pearsons Coefficient.csv", header = T, sep = ",", stringsAsFactors = F)
...
write.table(new.data, "DR3 D10 T Cells smaller K Sorted Pearsons Data.txt", sep = "\t", row.names = F)
