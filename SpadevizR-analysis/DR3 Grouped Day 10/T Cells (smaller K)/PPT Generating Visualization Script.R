...
matching_file_data = read.table("Matching Clusters for visualization.csv", header = T, sep = ",", stringsAsFactors = F)
...
# i=1
  ...
  image_write(Volcano_Plot_magick_CvV, path = "Control vs Vaccinated.jpeg", format = "jpeg")
  ...
  Volcano_Plot_CvV = paste(dir, "/Control vs Vaccinated.jpeg", sep = "")
  ...
  ph_with_img_at(src = Volcano_Plot_CvV, height = 2.1, width = 1.22, left = 6.07, top = 0.0)
...
print(doc, target = "DR3 D10 T Cell 99000per 37p genbyR.pptx")
